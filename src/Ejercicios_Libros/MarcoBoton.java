...
public MarcoBoton(){
   super("Prueba de botones");
    ...
    Icon fantas = new ImageIcon(getClass().getResource("fantas.gif"));
    Icon fantasma = new ImageIcon(getClass().getResource("fantasma.gif"));
     botonJButtonElegante = new JButton("Boton elegante", fantas); // establece la imagen
     botonJButtonElegante.setRolloverIcon(fantasma); // establece la imagen de sustitución
 ...
 {
 JOptionPane.showMessageDialog(MarcoBoton.this, String.format("Udted oprimio: %s", evento.getActionCommand()));
 }
 }

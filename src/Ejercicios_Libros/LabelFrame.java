...
public LabelFrame() {
super("Preba de Jlabel");
    setLayout(new FlowLayout()); // establece el esquema del marco
    // Constructor de JLabel con un argumento String
    etiqueta1 = new JLabel("Etiqueta con texto");
    etiqueta1.setToolTipText("Esta  es etiqeta1");
    add(etiqueta1); // agrega etiqueta1 a JFrame
// Constructor de JLabel con argumentos de cadena, Icono y alineación
 Icon Gok = new ImageIcon(getClass().getResource("Gok.jpeg"));
etiqueta2=new JLabel("Etiqueta con texto e icono", Gok , SwingConstants.LEFT);
...
add(etiqueta2); // agrega etiqueta2 a JFrame
    ...
    etiqueta3.setIcon(Gok); // agrega icono a JLabel
